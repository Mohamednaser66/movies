...
import 'package:movie/presentation/main_layout/tabs/profile/presentation/screens/widget/history_movies_view.dart';
import 'package:movie/presentation/main_layout/tabs/profile/presentation/screens/widget/wish_list_view.dart';
...
class _ProfileState extends State<Profile>  with SingleTickerProviderStateMixin {
  ...
  history=  context.read<ProfileCubit>().historyMovies;
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Column(
                children: [
                  Text(history.length.toString(),style: Theme.of(context).textTheme.bodyLarge,),
                  SizedBox(height: 16.h,),
    ...
    return Center(child:  CircularProgressIndicator(color: ColorsManger.yellow,),);
            ...
            Expanded(
              child: Container(
                ...
                child: TabBarView(
                  controller: _controller,
                    children: [WishListView(),HistoryMoviesView()])
              ),
            )
